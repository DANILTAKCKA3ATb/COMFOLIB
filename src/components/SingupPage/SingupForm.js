    ...
    return (
        <Form
            ...
            render={formProps => {
                ...
                const errorMessage = onError ? (onError.code === USER_TAKEN ? 'This email is already registered' : 'Something went wrong. Try again') : null;
                ...
                return (
                    <form sx={{ width: '100%', mt: 3 }} onSubmit={handleSubmit}>
                        ...
                        <Button type='submit' fullWidth variant='contained' color='primary' sx={{ mt: 2 }} startIcon={inProgress ? <CircularProgress /> : null}>
                            Sign Up
                        </Button>
