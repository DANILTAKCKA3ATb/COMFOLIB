...
const BookshelfPage = ({ isAdminPage, ...props }) => {
  ...
  const { bookshelfBooks, bookshelfBooksId, getBookshelfBooksInProgress, getBookshelfBookError } =
    useSelector(state => state.bookshelf);
  ...
  return (
    ...
    >
      <Backdrop
        ...
        open={getBookshelfBooksInProgress}
      >
