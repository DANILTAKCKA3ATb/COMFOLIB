...
const CreateLibraryPage = props => {
    ...
    const { creationLibraryInProgress, creationLibraryError, libraryForChange } = useSelector(state => state.createLibrary);
    ...
    return (
        ...
        >
            <CreateLibraryForm onSubmit={handleSubmit} inProgress={creationLibraryInProgress} onError={creationLibraryError} />
        </Paper>
    );
};
